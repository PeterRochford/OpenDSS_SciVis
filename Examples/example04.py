'''
How to create a plot showing change of power system quantity with time.

A fourth example of how to create a plot of frequency over time that is 
sub-sampled by 60 and displayed using markers of blue semi-transparent 
circles (alpha = 0.2). 
...
if __name__ == '__main__':
    ...
    variables = ['t(sec)', 'Frequency (Hz)']
    tsdata = osv.get_time_series(variables,data,subsample = 60)
    ...
    osv.time_series_plot(tsdata, markerdisplayed = 'marker', markerSymbol = 'o', 
                         markerColor = 'b', alpha = 0.2)

    # Write plot to file if arguments say so
    None if args.no_save else plt.savefig('example04.png')
