...
A second example of how to plot a specific quantity in an OpenDSS CSV file, 
in this case frequency as a function of time. 
...
if __name__ == '__main__':
    ...
    >> time_series_plot
    '''
    osv.time_series_plot(tsdata, linespec = 'b--')

    # Write plot to file if arguments say so
    None if args.no_save else plt.savefig('example02.png')
